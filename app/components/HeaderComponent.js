...
import {
  ...
  StatusBar, Dimensions, Platform, Image, Animated, Alert
} from "react-native";
    ...
    return (
      <View>
        <Modal animationIn={"slideInLeft"} animationOut={"slideOutLeft"} backdropTransitionOutTiming={0}
          ...
          <View style={[styles.menuContent ,(this.state.myProfile) ? styles.fullWidth : styles.defaultWidth]}>
            {
            ...
            {
              this.state.myProfile &&
              <TouchableOpacity style={styles.backProfileIcon} onPress={() => { this.navigateToMenu() }}>
                <Icon name={"chevron-back"} style={styles.ProfileIcon} />
                <Text style={styles.backprofile}>My Profile</Text>
              </TouchableOpacity>
            }
            {
            ...
            }
            {
                ...
                <View style={styles.profileBox}>
                  <View style={[styles.listBox,styles.listBoxProfile]}>
                    <TouchableOpacity style={[styles.linkBox, (this.state.tabActive) ? styles.activetabBg : styles.tabBg]} onPress={this.navigateToPersonalDetail}>
                      <Image style={styles.listIcon} source={require('../assets/img/account.png')} resizeMode="contain" />
                      <Text style={styles.listLink}>Update Personal Detail</Text>
                    ...
                    <View style={styles.borderDashed}></View>
                      ...
                      <View style={styles.borderDashed}></View>
                    <TouchableOpacity style={styles.linkBox} onPress={this.navigateToMyOrders}>
                      <Image style={styles.listIcon} source={require('../assets/img/orderbox.png')}
                        resizeMode="contain" />
...
const styles = StyleSheet.create({
  ...
  listLink: {
    ...
    marginRight: viewportWidth * 0.04,
    fontFamily: Typography.FONT_REGULAR,
