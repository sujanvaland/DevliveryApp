...
class SignUpView extends Component {
  ...
  render() {
    ...
    return (
      ...
      <Image style={styles.loginBg} source={require('../../assets/img/delivery_login.jpg')} resizeMode="cover" /> 
      ...
      <KeyboardAvoidingView style={styles.container} enabled>
        ...
        <View style={styles.logoContainer}>
          ...
          />
          <Image style={styles.logoImg} source={require('../../assets/img/logo-img.png')} resizeMode="contain" /> 
        </View>
        ...
        <View style={globalStyles.loginContainer}>
          ...
          {/* <View style={styles.loginBottom} >
            <LinkButton onPress={this.navigateToSignUp} title={button.SIGNUP} />
            <LinkButton onPress={this.navigateToForgotPassword} title={button.FORGOTPASSWORD} />
          </View> */}
        </View>
